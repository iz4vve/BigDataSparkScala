...
object WikipediaRanking {
  ...
  val conf: SparkConf = new SparkConf().setAppName("WikipediaAssignment")
  ...
  /** Returns the number of articles on which the language `lang` occurs.
    ...
    */
  def occurrencesOfLang(lang: String, rdd: RDD[WikipediaArticle]): Int = wikiRdd.filter(article => article.text contains lang).count.toInt
